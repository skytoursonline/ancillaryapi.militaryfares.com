...
class airobotAPIcheckinpassenger extends airobotAPI
{
    protected $url_request = 'v2/checkin/{request_id}/boardingpass/{passenger_journey_id}';
    ...
    public function __construct($request)
    {
        ...
        $this->url_request = str_replace(['{request_id}','{passenger_journey_id}'],[$request['request_id'],$request['passenger_journey_id']],$this->url_request);
//        $this->http_header[] = 'expectedTestResult: success'; // "success" or "failed" (used for testing)
    }
}

class airobotAPIcheckinpassengerResult
{
