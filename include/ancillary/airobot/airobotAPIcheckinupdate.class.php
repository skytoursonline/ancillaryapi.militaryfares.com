...
class airobotAPIcheckinupdate extends airobotAPI
{
        ...
        foreach ($this->origin as $fkey => $value) {
            foreach ($value as $skey => $val) {
                $this->request['journeys'][] = [
                    ...
                    'id_booking'        => $this->id_booking[$fkey][$skey],
                    'pnr'               => $this->pnr[$fkey][$skey],
                    'ticket_number'     => $this->ticket_number[$fkey][$skey],
                ];
            }
        }
    }
...
class airobotAPIcheckinupdateResult
{
