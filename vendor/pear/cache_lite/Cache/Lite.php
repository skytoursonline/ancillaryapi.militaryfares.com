...
class Cache_Lite
{
    ...
    */
    ...
    private $_hashedDirectoryGroup  = null;
    private $_cacheFileMode         = null;
    private $_cacheFileGroup        = null;
    ...
    */
    ...
    {
        error_log("CACHE ERROR $code: $msg");
/*
...
*/
    ...
    */
    private function _cleanDir($dir,$group = false,$mode = 'ingroup')     
    {
        ...
        if (!($dh = opendir($dir))) {
            return $this->raiseError('Cache_Lite : Unable to open cache directory : '.$dir,-4);
        }
        $result = true;
    ...
    */
    private function _read()
    {
        ...
        return $this->raiseError('Cache_Lite : Unable to read cache : '.$this->_file,-2);
    }
    ...
    */
    private function _write($data)
    {
        ...
        $is_newfile = (!is_null($this->_cacheFileMode) || !is_null($this->_cacheFileGroup)) && !@file_exists($this->_file);
    ...
    */
    ...
    public function getFilename($id,$group = 'default')
    {
        $this->_setFileName($id,$group);
        return $this->_file;
    }
